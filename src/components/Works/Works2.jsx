...
const WorksRight = ({ 
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="absolute top-1/2 right-full -translate-y-1/2 mr-[-30%] max-w-md w-[320px] bg-black bg-opacity-70 text-white p-6 rounded-lg border border-white/20 shadow-xl backdrop-blur-md z-20"
        variants={containerVariants}
        initial="hidden"
        whileInView="visible"
        viewport={{ once: false, amount: 0.5 }}
